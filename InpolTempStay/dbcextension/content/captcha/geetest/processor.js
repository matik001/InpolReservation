CaptchaProcessors.register({
    ...
    onSolved: function(widget, answer) {
        ...
        helper.find("input[name=geetest_challenge]").val(answer.challenge);
        helper.find("input[name=geetest_validate]").val(answer.validate);
        helper.find("input[name=geetest_seccode]").val(answer.seccode);
    ...
    getHelper: function(widget) {
        ...
        let helper = container.find(".dbc-geetest-helper");

        if (!helper.length) {
            helper = $(`
                <div class="dbc-geetest-helper">
